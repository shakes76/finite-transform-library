...
*/
    ...
    #ifndef FORMAT_INPUT_FLOAT_STR
        #define FORMAT_INPUT_FLOAT_STR "%f"
    #endif
    #ifndef FORMAT_OUTPUT_FLOAT_STR
        #define FORMAT_OUTPUT_FLOAT_STR "%f "
    #endif
    #ifndef FORMAT_CSVOUTPUT_FLOAT_STR
        #define FORMAT_CSVOUTPUT_FLOAT_STR "%f,"
    #endif
